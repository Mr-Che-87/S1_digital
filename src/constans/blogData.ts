export const blogData = [
  ...
  {
    title:
      "Как правильно купить рекламу в Google AdWords — советы и инструкции",
    link: "googleadwordsladvertising",
    img: "googleadwordsladvertising/preview.jpg",
    pageImg: "/images/blogs/googleadwordsladvertising/main.jpg",
    text: "Разберем все нюансы работы с Google AdWords. Вы узнаете, как выбрать наиболее эффективные настройки рекламы, определить целевую аудиторию и составить привлекательные объявления. Мы также дадим рекомендации по оптимизации бюджета и аналитике результатов, чтобы вы могли получить максимальную отдачу от своих рекламных инвестиций.",
    date: "02.06.2022",
    photo: "/images/blogs/googleadwordsladvertising/main.jpg",
    photoText: [
      "Хотите заказать рекламу в Яндекс.Директ и Google AdWords? Не знаете, какое агентство выбрать? Наше агентство S1 предлагает качественные услуги по настройке и оптимизации рекламных кампаний в Яндекс.Директ и Google AdWords.",
      "Заказать услугу у нас — значит получить профессиональную помощь в продвижении вашего бизнеса в интернете. Мы предлагаем комплексный подход к рекламе, анализ конкурентов, подбор ключевых слов, составление эффективных объявлений и постоянный мониторинг результатов.",
      "Выбирайте нас, и ваша реклама в Яндекс.Директ и Google AdWords станет настоящим инструментом привлечения клиентов и увеличения прибыли вашего бизнеса!",
    ],
    blogData: [
      {
        title: "",
